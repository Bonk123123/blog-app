    ...
    <main className='flex container flex-col min-h-[calc(100vh-104px)] mx-auto justify-center items-center py-4 px-2 sm:px-10 md:px-20 lg:px-40 xl:px-60 2xl:px-80 w-full'>
      <div className=' bg-body-light dark:bg-navbar-dark rounded-xl border dark:border-none shadow w-[95%] sm:w-[60%] h-[60%]'>
        <form className='flex flex-col justify-center items-center h-full gap-8 p-4'>
          <h1 className='uppercase text-xl -translate-y-10'>Registration</h1>
          ...
          <div className='flex w-[80%] gap-2'>
            <button className='p-1 w-1/2 border rounded-xl hover:bg-slate-100 dark:hover:bg-[#333333] duration-75 text-center' type="submit">register</button>
            <Link className='p-1 w-1/2 border rounded-xl hover:bg-slate-100 dark:hover:bg-[#333333] duration-75 text-center' href={'/login'}>sign in</Link>
          </div>
        </form>
      </div>
    </main>
